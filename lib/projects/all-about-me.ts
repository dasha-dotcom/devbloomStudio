...
export const allAboutMeLessonSteps: LessonStep[] = [
  ...
  },
  {
    ...
    isGate: false,
    reflectionPrompt: "One thing I changed in the HTML was ___. It changed my page by ___.",
    reflectionPlaceholder: "Example: I changed the heading, and it made my page show my topic.",
